...
export function Header() {
  const [notifications, setNotifications] = useState([
    {
      ...
      description: "You received a payment of $49.99",
      time: "2 minutes ago",
      read: false,
    },
    {
      ...
      description: "A new checkout session was created",
      time: "1 hour ago",
      read: false,
    },
    {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 items-center gap-4 border-b bg-background px-4 sm:px-6">
      <Button variant="outline" size="icon" id="sidebar-toggle" onClick={toggleSidebar}>
