...
export function QRCodeScanner({ onScan, onError, autostart = true }: QRCodeScannerProps) {
  ...
  // Start camera when component mounts if autostart is true
  useEffect(() => {
    if (autostart) {
      startCamera()
    }
    ...
    if (video.readyState === video.HAVE_ENOUGH_DATA && context) {
      ...
      if (code) {
        ...
        try {
          ...
          // Call onScan callback with parsed data
          onScan(parsedData)
        } catch (error) {
